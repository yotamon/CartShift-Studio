# Link Building Tracker & Outreach Templates
...
**Link Types**: Guest Post, Resource Link, Directory, HARO, Broken Link, Competitor Backlink, Partner Link, Editorial, Podcast, Webinar
...
P.S. [Optional personal note showing you genuinely follow their content]
```

---

### Template 2: Guest Post Pitch (Warm Introduction)

**Subject:** "Referred by [Mutual Connection] - Guest post for [Their Site]"
...
I was researching [topic] and came across your excellent article: "[Their Article Title]"
...
I came across your resource page on [topic]: [Their URL]

This is a fantastic collection! I noticed you include resources on [specific subtopic].

I recently published an in-depth guide that your visitors might find valuable:
[Your URL] - "[Your Title]"
...
### Template 5: Skyscraper Technique Outreach

**Subject:** "Enjoyed your link to [Original Content] - thought you'd like this too"
...
### Template 6: HARO (Help A Reporter Out) Response
...
[Your expert answer - 2-4 paragraphs of valuable, quotable content]

[Optional: Include relevant statistic or data point]

Feel free to use this quote and attribute it to:
[Your Name]
[Your Title], CartShift Studio

Happy to provide additional context or answer follow-up questions!
...
### Template 7: Unlinked Brand Mention

**Subject:** "Quick request about your mention of CartShift Studio"
...
### Template 8: Partner/Complementary Business Outreach
...
• Linking to each other as trusted partners?
...
A bit about me:
[Brief credentials - 2-3 sentences highlighting relevant expertise and unique perspective]

I've prepared some talking points and can send them over if you're interested.

Available dates: [Provide flexible availability]
...
### Template 10: Testimonial for Link

**Subject:** "Testimonial for [Their Product/Service]"
...
"[Your testimonial - 2-3 sentences highlighting specific benefits and results]"
...
3. Filter for:
   ...
   - One link per domain
4. Export list
5. Manually review for relevance
...
- "shopify" + "helpful sites"
- intitle:"resources" + "ecommerce"
- intitle:"links" + "web development"

**Action:** Compile list of 50+ resource pages, reach out with Template 4
...
4. "Migrating from WordPress to Shopify: Technical Considerations"
5. "Building Progressive Web Apps with Shopify"
6. "Shopify API Integration: Common Pitfalls and Solutions"
...
- Include credentials
- Follow-up if not used

**Goal:** 2-3 HARO links per month
...
- Editorial content (not spammy)
- Natural outbound links
- Responsive website owner
- Active social media
...
- [ ] 5 competitor backlink replications
- **Total Goal: 25-30 new links**
...
## Disavow File (For Bad Links)

If you acquire bad links, create a disavow file:

**File:** disavow.txt

```
# Bad links to disavow
# Format: domain:domain.com or url: https://exacturl.com

# Spammy directory
domain:spammydirectory.com

# Bought link (if you inherited site with bad links)
url: https://example.com/page-with-bad-link

# PBN link
domain:suspiciouspbn.com
```

Upload via Google Search Console > Disavow Links Tool (only if penalized!)
...
- Link to/from penalized domains
- Hide links or use sneaky redirects
...
6. Follow up 2-3 times max
7. Send Tuesday-Thursday mornings
8. Test subject lines
9. Use professional email (not @gmail)
...
**Track your progress weekly and adjust strategy based on what works!**
