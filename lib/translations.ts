...
export const translations = {
    ...
    portal: {
      ...
      auth: {
        ...
        signup: {
          ...
          subtitle: 'Get started with the CartShift portal',
          fullName: 'Full Name',
          email: 'Email Address',
          password: 'Password',
        ...
        errors: {
          ...
          genericInvite: 'Failed to load invite',
        },
      },
      invite: {
        ...
        expiredDesc: 'This invite has expired.',
        alreadyAccepted: 'Already Accepted',
        alreadyAcceptedDesc: 'This invite has already been accepted.',
        success: 'Invite Accepted!',
        redirecting: 'Redirecting you to the organization...',
        invitedEmail: 'Invited email:',
        role: 'Role:',
        invitedBy: 'Invited by:',
        expires: 'Expires:',
        guestIntro: 'To accept this invite, you need an account',
        createAccount: 'Create Account',
        signIn: 'Sign In',
        alreadyHasAccount: 'Already have an account? Click "Sign In" above',
        accept: 'Accept Invite',
        accepting: 'Accepting...',
        emailMismatch: 'This invite was sent to {email}, but you\'re signed in as {userEmail}. Please sign in with the correct email address.',
      },
      access: {
      ...
      files: {
        title: 'Files & Assets',
        subtitle: 'Unified storage for all your project documents and resources.',
        upload: 'Upload Asset',
        ...
        empty: {
          title: 'No assets syncronized',
          search: "We couldn't find any files matching your search.",
          noFiles: 'This organization workspace is currently empty.',
          uploadFirst: 'Upload First Asset',
          syncing: 'Syncing your assets...',
        },
        error: {
        ...
        uploadForm: {
          ...
          uploading: 'Uploading...',
          errorSize: 'File size must be less than 10MB',
          errorGeneric: 'Failed to upload file. Please try again.',
          cancel: 'Cancel',
          submit: 'Upload File',
        },
      },
      ...
      dashboard: {
        ...
        recent: {
          ...
          empty: {
            ...
            description: 'Start by creating your first request to get the ball rolling.',
          },
        },
        insight: {
          title: 'Insight',
          partner: 'Premium Partner',
          proPlan: "You're currently on the Pro plan. Enjoy priority design support and 24-hour turnaround.",
        ...
        // Keep old ones for future use maybe
        ecommerceTitle: 'E-commerce Command Center',
        ecommerceSubtitle: 'Monitor your conversion roadmap, performance metrics, and active project lifecycles.',
      },
      requests: {
        ...
        new: {
          ...
          subtitle: 'Fill in the details below to start a new task with your team.',
          attachments: 'Attachments',
          uploadText: 'Click to upload assets',
          uploadSubtext: 'Images, PDFs, or ZIP files',
          uploadHelp: 'Attaching relevant assets, brand guides, or screenshots helps our team deliver high-quality results faster.',
          tips: {
            title: 'Pro Tips',
            tip1: 'Be specific about the goals and expected outcomes of this request.',
            tip2: 'Include links to any design references, examples, or inspiration.',
            tip3: 'Break down complex tasks into smaller, focused requests for faster delivery.',
            tip4: 'Mention any deadlines or time-sensitive requirements upfront.',
          },
        },
        form: {
          titleLabel: 'What needs to be done?',
          titlePlaceholder: 'Summarize your request in a few words...',
          categoryLabel: 'Work Category',
          categorySelect: 'Select category...',
          priorityLabel: 'Importance Level',
          detailsLabel: 'Execution Details',
          detailsPlaceholder: 'Help our specialists understand the objective. Include:\n• Desired outcome\n• Examples or references\n• Technical constraints',
          footerNote: 'Request will be added to the queue immediately.',
          cancel: 'Cancel',
          submit: 'Dispatch Request',
          submitting: 'Initializing...',
          successTitle: 'Request Received!',
          successDesc: 'Your request has been filed. Project managers will review it shortly.',
          redirecting: 'Moving to request view...',
          errors: {
            auth: 'You must be logged in to create a request',
            ...
            descShort: 'Please provide more details (at least 20 characters)',
        ...
        detail: {
          ...
          notFoundDesc: 'The request you are looking for might have been deleted or moved, or you may not have permission to view it.',
          backToRequests: 'Back to Requests',
          designRequest: 'Design Request',
          details: 'Request Details',
          submissionDate: 'Submission Date',
          priorityStatus: 'Priority Status',
          discussion: 'Discussion History',
          emptyMessages: 'No messages yet',
          emptyMessagesDesc: 'Send a message to start the conversation.',
          ...
          accessing: 'Accessing Project Context...',
          archived: 'This growth objective may have been archived or moved by the agency team.',
          ...
          requestStrategicRevision: 'Request Strategic Revision',
        },
        types: {
          audit: 'Strategic Audit',
          conversion: 'Conversion Tweak',
          performance: 'Performance Fix',
          feature: 'New Store Feature',
      ...
      team: {
        title: 'Team Members',
        subtitle: 'Manage collaborators and permissions for this organization.',
        invite: 'Invite Colleague',
        ...
        noInvitesSub: 'Your team is fully active and synced up.',
        guideNote: 'Team members will receive an email to join this workspace. They can only see requests within this organization.',
        ...
        errors: {
          load: 'Failed to load team information.',
      ...
      settings: {
        title: 'Settings',
        subtitle: 'Manage your organization and workspace preferences.',
        tabs: {
          general: 'General',
          notifications: 'Notifications',
          security: 'Security',
        ...
        general: {
          ...
          subtitle: 'Basic info & Appearance',
          orgName: 'Organization Name',
          orgNamePlaceholder: 'e.g. Acme Corp',
          industry: 'Industry / Niche',
          industryPlaceholder: 'e.g. Technology, SaaS',
          website: 'Business Website',
          websitePlaceholder: 'https://acme.com',
          bio: 'Business Overview',
          bioPlaceholder: 'Give us a brief context about what you do...',
          save: 'Save Profile',
          saving: 'Processing...',
          success: 'Profile updated successfully!',
          error: 'Failed to save settings',
          permissionDenied: 'You do not have permission to access this organization',
          orgNotFound: 'Organization not found',
          newWorkspace: {
            title: 'New Workspace',
            description: 'Need another workspace? Create a separate organization for a different team.',
        ...
        notifications: {
          title: 'Channels & Alerts',
          subtitle: 'Email Delivery Settings',
          requestUpdate: {
            label: 'Request Milestone Updates',
            desc: "Notifications for every movement in your project's lifecycle.",
          },
          commentAlerts: {
            label: 'Real-time Comment Alerts',
            desc: 'Stay in the loop when specialists or team members engage.',
          },
          statusChange: {
            label: 'Direct Delivery Status',
            desc: "High-priority alerts for 'Delivered' and 'In Review' statuses.",
          },
          marketing: {
            label: 'Product & Design News',
            desc: 'Occasional insights from our studio on scaling your business.',
          },
          syncing: 'Syncing changes...',
          saved: 'Settings are live',
          pushBeta: 'Looking for browser push notifications?',
          pushBetaSub: 'Beta testing starting early 2026',
        },
        security: {
          title: 'Security Layer',
          subtitle: 'Control your access',
          changePassword: {
            title: 'Change Password',
            desc: 'Reset your password via a secure verification link sent to your email.',
            button: 'Request Reset Link',
            sent: 'Link Dispatched',
            success: 'Link Dispatched',
            error: 'Failed to send reset email.',
          },
          mfa: {
            title: 'Multi-Factor Auth (MFA)',
            desc: 'Add a mobile authenticator app for ultimate account protection.',
            badge: 'Pipeline 2026',
          },
          session: {
        ...
        billing: {
          ...
          nextPayment: 'Next payment cycle cycles on Jan 15, 2026',
          priority: 'Priority Ecosystem',
          proStatus: 'Pro Status',
          investment: 'Investment',
          workflowLimit: 'Workflow limit',
          ...
          encrypted: {
            title: 'Encrypted Billing Pipeline',
            desc: "Transactions are handled exclusively via Stripe's certified PCI Level 1 infrastructure. Your financial signatures never leave the Stripe ecosystem.",
          },
        },
      },
    },
  ...
  he: {
    ...
    portal: {
      loading: {
        init: 'מאתחל סביבת סטודיו',
        workspace: 'מתחבר לסביבת עבודה מאובטחת',
        auth: {
          login: 'טוען התחברות...',
          signup: 'טוען הרשמה...',
          invite: 'טוען הזמנה...',
      ...
      auth: {
        login: {
          title: 'ברוכים השבים',
          subtitle: 'התחברו לפורטל CartShift שלכם',
          email: 'אימייל',
          password: 'סיסמה',
          ...
          createOne: 'צרו אחד כאן',
          secure: 'גישה ארגונית מאובטחת',
        },
        signup: {
          title: 'צרו חשבון',
          subtitle: 'התחילו להשתמש בפורטל CartShift',
          fullName: 'שם מלא',
          email: 'כתובת אימייל',
          password: 'סיסמה',
        ...
        errors: {
          ...
          wrongPassword: 'אימייל או סיסמה לא נכונים.',
          ...
          emailInUse: 'חשבון עם אימייל זה כבר קיים.',
          weakPassword: 'הסיסמה חלשה מדי. אנא בחר סיסמה חזקה יותר.',
          matchPassword: 'הסיסמאות אינן תואמות',
          invalidCode: 'קוד הזמנה לא תקין',
          inviteNotFound: 'הזמנה לא נמצאה',
          alreadyAccepted: 'הזמנה זו כבר התקבלה',
          expired: 'פג תוקפה של ההזמנה',
          mismatch: 'הזמנה זו נשלחה לכתובת אימייל אחרת',
          genericInvite: 'טעינת ההזמנה נכשלה',
        },
      },
      invite: {
        title: 'הוזמנתם!',
        subtitle: 'הוזמנתם להצטרף לארגון',
        error: 'שגיאת הזמנה',
        notFound: 'הזמנה לא נמצאה',
        expired: 'פג תוקף ההזמנה',
        expiredDesc: 'הזמנה זו פגה.',
        alreadyAccepted: 'כבר התקבלה',
        alreadyAcceptedDesc: 'הזמנה זו כבר התקבלה בעבר.',
        success: 'ההזמנה התקבלה!',
        redirecting: 'מעביר אתכם לארגון...',
        invitedEmail: 'אימייל מוזמן:',
        role: 'תפקיד:',
        invitedBy: 'הוזמן על ידי:',
        expires: 'פג תוקף:',
        guestIntro: 'כדי לקבל את ההזמנה, עליכם ליצור חשבון',
        createAccount: 'צור חשבון',
        signIn: 'התחבר',
        alreadyHasAccount: 'כבר יש לכם חשבון? לחצו על "התחבר" למעלה',
        accept: 'קבל הזמנה',
        accepting: 'מקבל...',
        emailMismatch: 'הזמנה זו נשלחה ל-{email}, אבל אתם מחוברים כ-{userEmail}. אנא התחברו עם כתובת האימייל הנכונה.',
      },
      access: {
        restrictedTitle: 'הגישה מוגבלת',
        restrictedMessage: 'לפרופיל הנוכחי שלך אין את ההרשאות המתאימות לגשת לסביבת העבודה של ארגון זה.',
        switchWorkspace: 'החלף סביבת עבודה',
        contactSupport: 'צור קשר עם התמיכה',
      },
      files: {
        title: 'קבצים ונכסים',
        subtitle: 'אחסון מאוחד לכל מסמכי הפרויקט והמשאבים שלך.',
        upload: 'העלאת נכס',
        ...
        actions: {
          ...
          share: 'שיתוף',
          delete: 'מחיקה',
          deleteConfirm: 'האם אתם בטוחים שברצונכם למחוק קובץ זה?',
          deleted: 'הקובץ נמחק בהצלחה',
          deleteFailed: 'מחיקת הקובץ נכשלה',
        },
        empty: {
          title: 'אין נכסים מסונכרנים',
          search: 'לא מצאנו קבצים התואמים לחיפוש שלך.',
          noFiles: 'סביבת עבודה זו ריקה כרגע.',
          uploadFirst: 'העלה נכס ראשון',
          syncing: 'מסנכרן את הנכסים שלך...',
        },
        error: {
          title: 'שגיאת סנכרון נכסים',
          retry: 'נסה שוב',
        },
        uploadForm: {
          title: 'העלאת קובץ',
          browse: 'לחצו כדי לעיין בקבצים',
          maxSize: 'גודל קובץ מקסימלי: 10MB',
          uploading: 'מעלה...',
          errorSize: 'גודל הקובץ חייב להיות קטן מ-10MB',
          errorGeneric: 'העלאת הקובץ נכשלה. אנא נסו שוב.',
          cancel: 'ביטול',
          submit: 'העלה קובץ',
        },
      },
      settings: {
        title: 'הגדרות',
        subtitle: 'ניהול העדפות ארגון וסביבת עבודה.',
        tabs: {
          general: 'כללי',
        ...
        general: {
          title: 'פרופיל אירגוני',
          subtitle: 'מידע בסיסי ומראה',
          orgName: 'שם הארגון',
          orgNamePlaceholder: 'לדוגמה: Acme Corp',
          industry: 'תעשייה / נישה',
          industryPlaceholder: 'לדוגמה: טכנולוגיה, SaaS',
          website: 'אתר עסקי',
          websitePlaceholder: 'https://acme.com',
          bio: 'סקירה עסקית',
          bioPlaceholder: 'תן לנו הקשר קצר על מה אתם עושים...',
          save: 'שמור פרופיל',
          saving: 'מעבד...',
          success: 'הפרופיל עודכן בהצלחה!',
          error: 'שמירת ההגדרות נכשלה',
          permissionDenied: 'אין לך הרשאה לגשת לארגון זה',
          orgNotFound: 'הארגון לא נמצא',
          newWorkspace: {
            title: 'סביבת עבודה חדשה',
            description: 'צריך סביבת עבודה נוספת? צור ארגון נפרד לצוות אחר.',
            button: 'צור ארגון',
          },
          dangerZone: {
            title: 'אזור סכנה',
            description: 'מחק לצמיתות ארגון זה ואת כל הנתונים שלו. פעולה זו אינה הפיכה.',
            button: 'מחק סביבת עבודה',
          },
        },
        notifications: {
          title: 'ערוצים והתראות',
          subtitle: 'הגדרות מסירת דוא״ל',
          requestUpdate: {
            label: 'עדכוני אבני דרך בבקשות',
            desc: 'התראות על כל תזוזה במחזור החיים של הפרויקט שלך.',
          },
          commentAlerts: {
            label: 'התראות תגובה בזמן אמת',
            desc: 'הישאר מעודכן כאשר מומחים או חברי צוות מגיבים.',
          },
          statusChange: {
            label: 'סטטוס מסירה ישיר',
            desc: "התראות בעדיפות גבוהה לסטטוסים 'סופק' ו-'בבדיקה'.",
          },
          marketing: {
            label: 'חדשות מוצר ועיצוב',
            desc: 'תובנות מזדמנות מהסטודיו שלנו על הגדלת העסק שלך.',
          },
          syncing: 'מסנכרן שינויים...',
          saved: 'ההגדרות פעילות',
          pushBeta: 'מחפש התראות דפדפן?',
          pushBetaSub: 'בדיקות בטא מתחילות בתחילת 2026',
        },
        security: {
          title: 'שכבת אבטחה',
          subtitle: 'שלוט בגישה שלך',
          changePassword: {
            title: 'שנה סיסמה',
            desc: 'אפס את הסיסמה שלך באמצעות קישור אימות מאובטח שישלח למייל שלך.',
            button: 'בקש קישור לאיפוס',
            sent: 'קישור נשלח',
            success: 'קישור נשלח',
            error: 'שליחת קישור לאיפוס נכשלה.',
          },
          mfa: {
            title: 'אימות דו-שלבי (MFA)',
            desc: 'הוסף אפליקציית אימות ניידת להגנה מירבית על החשבון.',
            badge: 'בצנרת 2026',
          },
          session: {
            title: 'פרטי סשן פעיל',
            email: 'מזהה אימייל',
            provider: 'ספק זהות',
            mailService: 'שירות מייל',
          },
        },
        billing: {
          title: 'מנוי פרימיום',
          nextPayment: 'מחזור התשלום הבא ב-15 בינואר 2026',
          priority: 'אקוסיסטם מועדף',
          proStatus: 'סטטוס פרו',
          investment: 'השקעה',
          workflowLimit: 'מגבלת תהליכי עבודה',
          teamAvailability: 'זמינות צוות',
          unlimited: 'ללא הגבלה',
          perMonth: '/חודש',
          seats: '10 מושבים',
          stripeDashboard: 'לוח בקרה Stripe',
          invoicingHistory: 'היסטוריית חשבוניות',
          encrypted: {
            title: 'צנרת חיוב מוצפנת',
            desc: 'עסקאות מטופלות אך ורק דרך תשתית PCI Level 1 המוסמכת של Stripe. החתימות הפיננסיות שלך לעולם לא יוצאות מהאקוסיסטם של Stripe.',
          },
        },
      },
      sidebar: {
      ...
      common: {
        ...
        all: 'הכל',
        filter: 'סינון',
        showing: 'מציג {count} מתוך {total} תוצאות',
        prev: 'הקודם',
        next: 'הבא',
        recently: 'לאחרונה',
        general: 'כללי',
      ...
      dashboard: {
        title: 'לוח בקרה',
        subtitle: 'סקירה כללית של הפרויקטים הפעילים והפעילות האחרונה שלך.',
        loading: 'מנתח את הנתונים שלך...',
        error: {
          title: 'שגיאה בלוח הבקרה',
          retry: 'נסה שוב',
        },
        actions: {
          newRequest: 'בקשה חדשה',
          viewAll: 'צפה בהכל',
          createFirst: 'צור בקשה ראשונה',
        },
        stats: {
          total: 'סה"כ בקשות',
        ...
        recent: {
          title: 'בקשות אחרונות',
          empty: {
            title: 'אין בקשות עדיין',
            description: 'התחל ביצירת הבקשה הראשונה שלך כדי לצאת לדרך.',
          },
        },
        insight: {
          title: 'תובנה',
          partner: 'שותף פרימיום',
          proPlan: 'אתה כרגע בתוכנית Pro. תהנה מתמיכת עיצוב בעדיפות גבוהה וזמן תגובה של 24 שעות.',
          viewBenefits: 'צפה בהטבות התוכנית',
        },
        serviceStatus: {
          title: 'סטטוס שירות',
          design: 'צנרת עיצוב',
          ...
          responseTime: 'פחות משעתיים',
        },
        ecommerceTitle: 'מרכז שליטה איקומרס',
        ecommerceSubtitle: 'עקבו אחר מפת הדרכים להמרה, מדדי ביצועים ומחזורי חיים של פרויקטים פעילים.',
      },
      requests: {
        title: 'בקשות פרויקט',
        newRequest: 'בקשה חדשה',
        ...
        new: {
          title: 'צור בקשה חדשה',
          subtitle: 'מלאו את הפרטים מטה כדי להתחיל משימה חדשה עם הצוות שלכם.',
          attachments: 'קבצים מצורפים',
          uploadText: 'לחץ להעלאת קבצים',
          uploadSubtext: 'תמונות, PDF או קבצי ZIP',
          uploadHelp: 'הוספת קבצים רלוונטיים, מדריכי מותג או צילומי מסך עוזרת לצוות שלנו לספק תוצאות איכותיות מהר יותר.',
          tips: {
            title: 'טיפים מקצועיים',
            tip1: 'היו ספציפיים לגבי המטרות והתוצאות המצופות מבקשה זו.',
            tip2: 'כללו קישורים לרפרנסים עיצוביים, דוגמאות או השראה.',
            tip3: 'פרקו משימות מורכבות לבקשות קטנות וממוקדות יותר למסירה מהירה יותר.',
            tip4: 'ציינו דדליינים או דרישות רגישות לזמן מראש.',
          },
        },
        form: {
          titleLabel: 'מה צריך לעשות?',
          titlePlaceholder: 'תמצו את הבקשה שלכם בכמה מילים...',
          categoryLabel: 'קטגוריית עבודה',
          categorySelect: 'בחרו קטגוריה...',
          priorityLabel: 'רמת חשיבות',
          detailsLabel: 'פרטי ביצוע',
          detailsPlaceholder: 'עזרו למומחים שלנו להבין את היעד. כללו:\n• תוצאה רצויה\n• דוגמאות או רפרנסים\n• מגבלות טכניות',
          footerNote: 'הבקשה תתווסף לתור באופן מיידי.',
          cancel: 'ביטול',
          submit: 'שלח בקשה',
          submitting: 'מאתחל...',
          successTitle: 'הבקשה התקבלה!',
          successDesc: 'הבקשה שלכם הוגשה. מנהלי פרויקטים יסקרו אותה בהקדם.',
          redirecting: 'מעביר לתצוגת הבקשה...',
          errors: {
            auth: 'עליכם להיות מחוברים כדי ליצור בקשה',
            generic: 'יצירת הבקשה נכשלה. אנא נסו שוב.',
            titleShort: 'הכותרת חייבת להכיל לפחות 5 תווים',
            titleLong: 'הכותרת ארוכה מדי',
            descShort: 'אנא ספקו פרטים נוספים (לפחות 20 תווים)',
            typeRequired: 'אנא בחרו סוג בקשה',
          },
        },
        detail: {
          loading: 'פותח את הבקשה שלך...',
          notFound: 'בקשה לא נמצאה',
          notFoundDesc: 'הבקשה שאתם מחפשים אולי נמחקה או הועברה, או שאין לכם הרשאות לצפות בה.',
          backToRequests: 'חזרה לבקשות',
          designRequest: 'בקשת עיצוב',
          details: 'פרטי בקשה',
          submissionDate: 'תאריך הגשה',
          priorityStatus: 'סטטוס עדיפות',
          discussion: 'היסטוריית דיונים',
          emptyMessages: 'אין הודעות עדיין',
          emptyMessagesDesc: 'שלח הודעה כדי להתחיל את השיחה.',
          placeholder: 'שתפו משוב או שאלו שאלה...',
          workflowActions: 'פעולות זרימת עבודה',
          closeRequest: 'סגור בקשה',
          addAttachment: 'הוסף קובץ',
          requestRevision: 'בקש תיקון',
          assignedSpecialist: 'מומחה מוקצה',
          productTeam: 'צוות מוצר',
          specialist: 'מומחה',
          linkedAssets: 'נכסים מקושרים',
          noAssets: 'אין נכסים מצורפים',
          accessing: 'ניגש להקשר פרויקט...',
          archived: 'יעד צמיחה זה כנראה הועבר לארכיון או הוזז על ידי צוות הסוכנות.',
          returnToPipeline: 'חזור לצנרת',
          brief: 'תקציר היעד',
          initiated: 'נוצר',
          messages: 'הודעות',
          lifecycle: 'ניהול מחזור חיים',
          markFulfilled: 'סמן כבוצע',
          requestStrategicRevision: 'בקש רביזיה אסטרטגית',
        },
        upload: {
          title: 'העלאת קובץ',
          browse: 'לחצו כדי לעיין בקבצים',
        ...
        types: {
          audit: 'ביקורת אסטרטגית',
          conversion: 'שיפור המרה',
          performance: 'תיקון ביצועים',
          feature: 'פיצ׳ר חדש לחנות',
          migration: 'מיגרציית פלטפורמה',
          general: 'משימה כללית',
        },
      },
      team: {
        title: 'חברי צוות',
        subtitle: 'ניהול שותפים והרשאות בארגון זה.',
        invite: 'הזמן קולגה',
        activeMembers: 'חברים פעילים',
        anonymous: 'משתמש אנונימי',
        workspaceAccess: 'גישה לסביבת העבודה',
        ...
        noInvitesSub: 'הצוות שלך פעיל ומסונכרן לחלוטין.',
        guideNote: 'חברי צוות יקבלו אימייל להצטרפות לסביבת עבודה זו. הם יוכלו לראות רק בקשות בתוך ארגון זה.',
        workspaceGuide: 'מדריך סביבת עבודה',
        capacity: 'קיבולת מושבים',
        activeSeats: 'מושבים פעילים',
        upgrade: 'שדרג',
        roles: {
          owner: 'ראשי',
          member: 'פעיל',
        ...
        inviteForm: {
          ...
          emailPlaceholder: 'colleague@company.com',
          roleLabel: 'תפקיד והרשאות',
          cancel: 'ביטול',
          submit: 'שלח הזמנה',
          sending: 'שולח...',
          roles: {
            admin: 'מנהל - גישה מלאה',
            member: 'חבר - גישה רגילה',
            viewer: 'צופה - גישה לקריאה בלבד',
          },
          errors: {
            email: 'אנא הזן כתובת אימייל תקינה',
            role: 'אנא בחר תפקיד',
            generic: 'שליחת ההזמנה נכשלה. אנא נסה שוב.',
          },
        },
        errors: {
          load: 'טעינת פרטי הצוות נכשלה.',
          cancelInvite: 'ביטול ההזמנה נכשל',
        },
        confirmCancel: 'האם אתם בטוחים שברצונכם לבטל הזמנה זו?',
      },
    },
    heroForm: {
...
export function getNestedTranslation(obj: Record<string, unknown>, path: string): unknown {
  ...
  for (const key of keys) {
    if (result && typeof result === 'object' && result !== null && !Array.isArray(result)) {
      if (key in result) {
