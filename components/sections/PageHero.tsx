...
export const PageHero: React.FC<PageHeroProps> = ({ title, subtitle, description, badge, highlightLastWord = true, seoH1, compact = false }) => {
	return (
			...
			<div className="max-w-7xl mx-auto relative z-10 w-full">
				<div className="max-w-4xl mx-auto text-center">
					...
					<motion.h1
						...
						className={compact ? "text-3xl md:text-4xl lg:text-5xl font-display font-bold leading-tight tracking-tight mb-6 text-slate-900 dark:text-white" : "text-4xl md:text-5xl lg:text-6xl font-display font-bold leading-tight tracking-tight mb-6 text-slate-900 dark:text-white"}>
						{seoH1 ? (
							<>
