...
export const PageHero: React.FC<PageHeroProps> = ({
  ...
  return (
    <section className="relative min-h-[70vh] flex items-center justify-center py-20 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden bg-slate-50 dark:bg-surface-950">
      ...
      <div className="absolute top-0 left-0 w-full h-full bg-[url('/grid.svg')] opacity-[0.03] dark:opacity-10"></div>

      <div className="absolute top-[-10%] left-[-10%] w-[30rem] h-[30rem] bg-primary-400/10 dark:bg-primary-600/15 rounded-full blur-[80px] animate-slow-spin"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[30rem] h-[30rem] bg-accent-400/5 dark:bg-accent-600/10 rounded-full blur-[80px] animate-slow-spin" style={{ animationDirection: 'reverse' }}></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10 w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-lg md:text-xl text-slate-600 dark:text-surface-200 mb-6 font-light leading-relaxed"
          >
            {subtitle}
          </motion.p>
          ...
          <motion.p
            ...
            className="text-base md:text-lg text-surface-300 max-w-3xl mx-auto leading-relaxed"
          >
            {description}
          </motion.p>
        </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 bg-gradient-to-t from-slate-50 dark:from-surface-950 to-transparent z-20"></div>
    </section>
  );
};
