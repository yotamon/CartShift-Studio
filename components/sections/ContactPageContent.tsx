			...
			<div className="max-w-7xl mx-auto relative z-10">
				<div className="grid md:grid-cols-2 gap-8">
					<motion.div
						...
						<h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-white font-display mb-8 text-center md:text-start leading-tight tracking-tight">{t("contact.title") as string}</h2>
						<div className="space-y-6 text-start">
							...
							<div className="flex items-start gap-4">
								...
								<div>
									...
									<p className="text-slate-600 dark:text-surface-300 text-base md:text-lg leading-relaxed">{t("contact.quickResponseText") as string}</p>
								</div>
							</div>
							<div className="flex items-start gap-4">
								<Parallax speed={0.2}>
								...
								<div>
									...
									<p className="text-slate-600 dark:text-surface-300 mb-3 text-base md:text-lg leading-relaxed">{t("contact.scheduleText1") as string}</p>
									<a
										href={getScheduleUrl()}
										target="_blank"
						...
						{submitted ? (
							<Card>
								<CardContent className="text-center py-12">
									...
									<p className="text-slate-600 dark:text-surface-300 mb-6 text-base md:text-lg leading-relaxed">{t("contact.form.successText") as string}</p>
									...
									<div className="flex flex-col sm:flex-row gap-3 justify-center">
										<a href={getScheduleUrl()} target="_blank" rel="noopener noreferrer" className="inline-block">
								...
								<CardContent>
									<form onSubmit={handleSubmit(onSubmit)} className="space-y-5 text-start">
										...
										<div>
											...
											{errors.projectType && (
												<p id="contact-projectType-error" role="alert" className="mt-1 text-sm text-error">
										...
										<p className="text-xs text-surface-400 text-center">{t("contact.form.privacy") as string}</p>
									</form>
								</CardContent>
							</Card>
						)}
