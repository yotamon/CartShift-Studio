  ...
  >
    ...
    <div className={`h-full rounded-2xl p-6 lg:p-8 flex flex-col ${
      ...
      <div className="mb-6">
        ...
        <div className={`text-sm mt-1 ${popular ? "text-white/70" : "text-slate-500 dark:text-surface-500"}`}>
          {timeline}
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <CardContent>
                <ul className="space-y-3">
                  {pricing.included.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <Icon name="check" size={18} className="mt-0.5 text-green-600 dark:text-green-400 flex-shrink-0" />
          ...
          >
            <Card hover>
              <CardHeader>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 rounded-xl bg-slate-200 dark:bg-surface-700 flex items-center justify-center">
                    <Icon name="info" size={20} className="text-slate-600 dark:text-surface-400" />
                  </div>
              ...
              <CardContent>
                <ul className="space-y-3">
                  {pricing.notIncluded.items.map((item, i) => (
                    <li key={i} className="flex items-start gap-3">
                      <Icon name="minus" size={18} className="mt-0.5 text-slate-400 dark:text-surface-500 flex-shrink-0" />
                      <span className="text-slate-600 dark:text-surface-400">{item}</span>
                    </li>
                  ))}
                </ul>
