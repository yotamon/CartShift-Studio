    ...
    <div className="min-h-screen">
      <section className="relative py-20 md:py-28 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <Link
            href="/work"
            className="inline-flex items-center gap-2 text-sm text-slate-600 dark:text-surface-400 hover:text-accent-600 dark:hover:text-accent-400 mb-8 transition-colors"
          >
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm text-slate-500 dark:text-surface-500">
                {caseStudy.industry}
              </span>
            </div>
            ...
            <p className="text-xl text-slate-600 dark:text-surface-400">
              {caseStudy.brief}
            </p>
          </motion.div>
        </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-16">
            ...
            >
              ...
              <p className="text-lg text-slate-600 dark:text-surface-400 leading-relaxed">
                {caseStudy.challenge}
              </p>
            </motion.div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-slate-200 dark:border-surface-700">
                      <th className="text-start py-4 px-4 text-sm font-semibold text-slate-900 dark:text-white">
                        {labels.metric}
                      </th>
                      <th className="text-start py-4 px-4 text-sm font-semibold text-slate-900 dark:text-white">
                        {labels.before}
                  ...
                  <tbody>
                    {caseStudy.results.map((result, i) => (
                      <tr key={i} className="border-b border-slate-100 dark:border-surface-800">
                        <td className="py-4 px-4 text-slate-600 dark:text-surface-400">
                          {result.metric}
                        </td>
                        <td className="py-4 px-4 text-slate-500 dark:text-surface-500">
                          {result.before}
                        </td>
                        ...
                        <td className="py-4 px-4">
                          <span className={`font-bold ${
                            result.change.startsWith("+") || result.change.startsWith("-") && result.change.includes("57")
            ...
            {caseStudy.testimonial && (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5 }}
                className="bg-slate-50 dark:bg-surface-800/50 rounded-2xl p-8 md:p-12"
              >
                <h2 className="text-xl font-bold text-slate-900 dark:text-white mb-6">
                  {labels.clientSays}
                </h2>
                <blockquote className="text-xl md:text-2xl text-slate-700 dark:text-surface-300 italic mb-6 leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-gradient-to-b from-transparent to-slate-100 dark:to-surface-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 dark:text-surface-400 mb-8">
              {labels.ctaText}
            </p>
            <Link href="/contact">
              <Button size="lg">
