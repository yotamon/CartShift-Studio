...
export const WorkPageContent: React.FC = () => {
  ...
  return (
    <>
      ...
      <div className="sticky top-16 md:top-20 z-30 bg-white/95 dark:bg-surface-800/95 backdrop-blur-lg border-b border-slate-200 dark:border-surface-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
      ...
      <Section background="light" className="relative overflow-hidden">
                ...
                <Card hover className="h-full group relative overflow-hidden p-0">
                  <div className={`relative aspect-[4/3] overflow-hidden ${
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className={`relative w-20 h-20 rounded-2xl flex items-center justify-center backdrop-blur-sm transition-transform duration-300 group-hover:scale-110 ${
                        project.platform === "shopify"
                    ...
                    <div className="absolute top-3 right-3">
                      <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-xs font-semibold uppercase tracking-wide backdrop-blur-sm ${
                        project.platform === "shopify"
                  ...
                  <div className="p-6">
                    <div className="mb-3">
                      <span className="inline-block text-xs font-medium text-slate-500 dark:text-surface-400 mb-2">
                        {project.industry}
                      </span>
                    ...
                    <p className="text-sm text-slate-600 dark:text-surface-400 mb-4 line-clamp-3 leading-relaxed">
                      {project.brief}
                    </p>
        ...
        >
          <p className="text-slate-500 dark:text-surface-500 italic">
            {work.comingSoon}
          </p>
        </motion.div>
      </Section>
