          ...
          >
            <TiltCard tiltStrength={8} glare>
              <Card hover accent className="h-full group relative overflow-hidden">
                ...
                <CardContent>
                  <p className="mb-8 text-base md:text-lg leading-relaxed text-slate-700 dark:text-surface-200">
                    {service.description}
                  </p>
                    ...
                    {service.features.map((feature, idx) => (
                      ...
                      >
                        <Check
                          ...
                          strokeWidth={2.5}
                        />
                        <span className="text-slate-700 dark:text-surface-200 text-base md:text-lg font-medium">
                          {feature}
                        </span>
                      </motion.li>
                    ))}
